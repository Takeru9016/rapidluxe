  ...
  return (
    <div className="flex items-center justify-between py-2">
      <div>
        ...
        <p className="text-xs font-sans text-(--color-text-secondary)">
          {sublabel}
        </p>
      </div>
      <div className="flex items-center gap-3">
        ...
        <span className="w-4 text-center font-mono text-white text-sm">
          {value}
        </span>
        <button
          onClick={onIncrement}
...
export function SearchBar({ variant = "hero", className }: SearchBarProps) {
  ...
  return (
    ...
    >
      {/* Destination */}
      <div className="flex-1 flex items-center gap-3 px-5 py-4 border-b border-(--color-navy-border) md:border-b-0 md:border-r">
        <MapPin size={16} className="text-(--color-gold) shrink-0" />
        <div className="flex-1 min-w-0">
          <p className="text-xs font-sans text-(--color-text-secondary) mb-0.5">
            Destination
          </p>
          <input
            type="text"
            ...
            className="w-full bg-transparent font-sans text-white placeholder:text-(--color-text-secondary) outline-none text-sm"
          />
        </div>
      </div>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button className="flex-1 flex items-center gap-3 px-5 py-4 border-b border-(--color-navy-border) md:border-b-0 md:border-r text-left hover:bg-white/5 transition-colors">
            <Calendar size={16} className="text-(--color-gold) shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-sans text-(--color-text-secondary) mb-0.5">
                Date
              </p>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button className="flex-1 flex items-center gap-3 px-5 py-4 border-b border-(--color-navy-border) md:border-b-0 md:border-r text-left hover:bg-white/5 transition-colors">
            <Users size={16} className="text-(--color-gold) shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-xs font-sans text-(--color-text-secondary) mb-0.5">
                Travelers
              </p>
              <p className="text-sm font-sans text-white truncate">
                {travelerSummary()}
              </p>
            </div>
          </button>
