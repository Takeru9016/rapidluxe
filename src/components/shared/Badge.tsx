...
const variantStyles: Record<BadgeProps['variant'], string> = {
  ...
  coral: 'bg-[var(--color-coral)]/20 text-[var(--color-coral)] border border-[var(--color-coral)]/30',
  ghost: 'bg-white/5 text-[var(--color-white-muted)] border border-white/10',
  outline: 'bg-transparent text-[var(--color-white)] border border-[var(--color-navy-border)]',
}
