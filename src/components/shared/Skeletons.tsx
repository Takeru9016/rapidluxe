...
function Bone({ className }: { className?: string }) {
  return (
    <div className={cn('bg-[var(--color-navy-border)] rounded animate-pulse', className)} />
  )
}

export function PackageCardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('rounded-xl overflow-hidden border border-[var(--color-navy-border)]', className)}>
...
export function DestinationCardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('rounded-xl overflow-hidden aspect-[3/4] relative bg-[var(--color-navy-border)]', className)}>
...
export function ReviewCardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('rounded-xl p-6 border border-[var(--color-navy-border)]', className)}>
...
export function BookingCardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('rounded-xl p-5 border border-[var(--color-navy-border)]', className)}>
